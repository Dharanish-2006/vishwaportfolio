            ...
            <div key={i} className="flex items-center gap-10 px-6 shrink-0">
              {["Video Editing", "Motion Graphics", "Color Grading", "Sound Design", "Storytelling", "Branding", "Cinematic Edit", "Kinetic Type"].map((w) => (
                <span key={w} className="flex items-center gap-10">
                  <span className="text-white font-display text-2xl font-bold uppercase tracking-tight">{w}</span>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row md:justify-between md:items-end mb-16 gap-6">
            <div>
              ...
              <h2 className="font-display text-5xl md:text-6xl font-bold text-white tracking-tighter">Recent Hits.</h2>
            </div>
